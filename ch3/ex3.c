...
// first format string to fail. These strings are not equivalent.
*/
...
// setup, I provided the first (c) input a value of "1{return}" and the program
// hanged, so I then entered "{space}{return}" and the program continued to
// hang. I then entered "2{return}" and the program completed by printing this
// way in terminal (`user input` {invisible character descriptive name}):
//
